...
rawDataPath = "${projectPath}/data/raw-seq/runC/Cal07/"
Channel
...
/*Output paths*/
trimPath = "${projectPath}/results/Dec2017-runC/Cal07/trimmomatic"
fastqcPath = "${projectPath}/results/Dec2017-runC/Cal07/fastqc_trim"
alignPath = "${projectPath}/results/Dec2017-runC/Cal07/bowtie2"
viremaPath = "${projectPath}/results/Dec2017-runC/Cal07/virema"
