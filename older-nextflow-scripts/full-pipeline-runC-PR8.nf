...
rawDataPath = "${projectPath}/data/raw-seq/runC/PR8/"
Channel
...
/*Output paths*/
trimPath = "${projectPath}/results/Dec2017-runC/PR8/trimmomatic"
fastqcPath = "${projectPath}/results/Dec2017-runC/PR8/fastqc_trim"
alignPath = "${projectPath}/results/Dec2017-runC/PR8/bowtie2"
viremaPath = "${projectPath}/results/Dec2017-runC/PR8/virema"
