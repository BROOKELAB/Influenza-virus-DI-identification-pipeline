...
rawDataPath = "${projectPath}/results/Dec2017-runB"
pr8reads = Channel.fromPath("${rawDataPath}/PR8/bowtie2/*_unaligned.fq")
cal07reads = Channel.fromPath("${rawDataPath}/Cal07/bowtie2/*_unaligned.fq")
...
/*Output paths*/
pr8Path = "${projectPath}/results/Mar2017-Fuzz-virema/runB/PR8"
cal07Path = "${projectPath}/results/Mar2017-Fuzz-virema/runB/Cal07"
