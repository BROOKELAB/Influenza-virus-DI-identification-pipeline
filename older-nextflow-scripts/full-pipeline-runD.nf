...
rawDataPath = "${projectPath}/data/raw-seq/runD"
Channel
...
/*Output paths*/
trimPath = "${projectPath}/results/Feb2017-runD/trimmomatic"
fastqcPath = "${projectPath}/results/Feb2017-runD/fastqc_trim"
alignPath = "${projectPath}/results/Feb2017-runD/bowtie2"
viremaPath = "${projectPath}/results/Feb2017-runD/virema"
