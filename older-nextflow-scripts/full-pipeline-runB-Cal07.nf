...
bowtie2_index = "${projectPath}/data/genome/bowtie2-2.3.2-index/Cal07"
virema_index = "${projectPath}/data/genome/bowtie-1.2.0-index/Cal07_padded"

viremaApp = "${projectPath}/apps/ViReMa_0.6"

/* Path to raw fastq files */
rawDataPath = "${projectPath}/data/raw-seq/45_samples/Cal07"
Channel
...
bowtie2Mem = '15'
bowtie2CPU = '6'
viremaMem = '200' /*Temporarily increased for 36B & 37B*/
viremaCPU = '16' /*Temporarily increased for 36B & 37B*/
...
/*Output paths*/
trimPath = "${projectPath}/results/Dec2017-runB/Cal07/trimmomatic"
fastqcPath = "${projectPath}/results/Dec2017-runB/Cal07/fastqc_trim"
alignPath = "${projectPath}/results/Dec2017-runB/Cal07/bowtie2"
viremaPath = "${projectPath}/results/Dec2017-runB/Cal07/virema"
